...
class Scene {
 public:
  ...
  void addMarker2(int id, const rtabmap::Transform & pose);
  ...
  BackgroundRenderer * background_renderer_;
    ...
    void addPoint(int id, const rtabmap::Transform & pose);
    void setPointPose(int id, const rtabmap::Transform & pose);
 ...
 private:
  ...
  std::map<int, PointCloudDrawable*> cropWireframeClouds_;
    ...
    float lineWidth_;
    bool polygonClosed_;
    std::map<int, rtabmap::Mesh> originalMeshes_;
};
